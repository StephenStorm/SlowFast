...
def construct_loader(cfg, split, is_precise_bn=False):
    ...
    if split in ["train"]:
        dataset_name = cfg.TRAIN.DATASET                        #kinetics
        batch_size = int(cfg.TRAIN.BATCH_SIZE / cfg.NUM_GPUS)   # 64
        shuffle = True
        drop_last = True
    elif split in ["val"]:
        ...
        dataset_name = cfg.TEST.DATASET                         #kinetics
        batch_size = int(cfg.TEST.BATCH_SIZE / cfg.NUM_GPUS)    #64
        shuffle = False
        drop_last = False
